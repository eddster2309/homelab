...
url --url="http://aarnet.repos.example.com/pub/rocky/10/BaseOS/x86_64/os/"
repo --name="AppStream" --baseurl=http://aarnet.repos.example.com/pub/rocky/10/AppStream/x86_64/os/
...
network --hostname=rocky10.localdomain
